...
namespace WebServer.Interfaces
{
    public interface IDirectService
    {
        ...
        Response<string> EditDirectMessage(int userId, int targetId, int directMessageId, DirectMessage editedMessage);
        Response<string> DeleteDirectMessage(int userId, int targetId, int directMessageId);
